...
_[ZAYN Heardle](https://zayn-heardle.glitch.me/) by [@eggtartemily](https://twitter.com/eggtartemily)_
...
4. In the `index.html` file, change every instance of 'ZAYN' to your artist. You can find and replace all by hitting command+option+F on Mac or ctrl+F on Windows.
