var app = (function () {
      ...
      m.$on("click", e[4]),
      {
        c() {
          (t = w("header")),
            ...
            (l = x()),
            (u = w("h1")),
            (u.textContent = "Yorushika Heardle"),
            (c = x()),
            (d = w("div")),
            Q(h.$$.fragment),
            (f = x()),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">Inspired by Heardle from Spotify, but made for Yorushika songs. Each song is randomly chosen from their discography.</p> \n\n<p class="mb-3">Made by <a href="https://github.com/emilywang188">@emilywang188</a>. All copyright goes to Yorushika, Universal Music Japan, and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/yorushika-heardle-game">here</a>.'),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  const Vt = {
    ...
    Jt = [
      "This is why Zayn likes UFC over us", // failed :(
      "That's inZAYN!", // first try
      "Zquad indeed!",
      "AmaZAYN",
      "You must've done this BeFoUr",
      "Almost got exposed",
      "Need to relisten, huh?", // sixth try
    ];
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Yorushika song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Yorushika Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Yorushika Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's Yorushika Heardle. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
    ...
    return (
      ...
      [
        ...
        () => {
          ...
          let e = "Yorushika Heardle #" + (s.id + 1),
            t = "";
          a
          ...
          for (let e = 0; e < i.maxAttempts; e++)
            r.length > e
              ? 1 == r[e].isCorrect
                ...
                : (t += "🟥")
              : (t += "⬜️");
          let o = e + "\n\n" + t + "\n\n" + "https://yorushika-heardle-game.glitch.me/";
          if (
            !navigator.share ||
      ...
      subscribe: ue(
        [
          ...
          },
          {
            ...
            answer: "M.I.A. - Freedun (feat. ZAYN)",
          },
          {
          ...
          {
            url: "https://soundcloud.com/zaynofficial/angel",
            answer: "ZAYN - Angel",
          },
          {
          ...
          },
          {
            ...
            answer: "ZAYN - wHo",
                    ...
                    {
            url: "https://soundcloud.com/zaynofficial/love-like-this",
            answer: "ZAYN - Love Like This",
          },
          {
          ...
          {
            url: "https://soundcloud.com/yung-bleu/yung-bleu-zayn-fire-inside",
            answer: "Yung Bleu & ZAYN - Fire Inside",
          },
          {
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Yorushika Heardle"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the Yorushika song from the intro in as few tries as possible"
          ),
